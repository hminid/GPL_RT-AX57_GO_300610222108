...
#endif
#if defined(GTBE98) || defined(GTBE98_PRO) || defined(RTBE96U) || defined(GTBE96)
	int bufmem = 0;
	if (f_read_string("/proc/environment/bufmem", value, sizeof(value)) > 0)
		bufmem = atoi(value);
...
#elif defined(XT12) || defined(ET12) || defined(GTBE98) || defined(GTBE98_PRO) || defined(GTBE96)
...
void init_switch_pre()
{
...
#endif
#if !defined(RTAX95Q) && !defined(XT8PRO) && !defined(BT12) && !defined(BQ16) && !defined(BM68) && !defined(XT8_V2) && !defined(RTAXE95Q) && !defined(ET8PRO) && !defined(ET8_V2) && !defined(RTAX56_XD4) && !defined(XD4PRO) && !defined(CTAX56_XD4) && !defined(RTAX55) && !defined(RTAX1800) && !defined(RTAX82_XD6S) && !defined(RPAX56) && !defined(RPAX58) && !defined(RTAX58U_V2) && !defined(ET12) && !defined(XT12) && !defined(GT10) && !defined(RTAX3000N) && !defined(BR63) && !defined(GTBE98) && !defined(GTBE98_PRO) && !defined(XC5) && !defined(EBA63) && !defined(GTBE96)
	add_to_list("eth4", ifnames, sizeof(ifnames));
#endif
#if defined(RTCONFIG_EXT_BCM53134) || defined(RTCONFIG_EXTPHY_BCM84880)
#if !defined(RTAX95Q) && !defined(XT8PRO) && !defined(BT12) && !defined(BQ16) && !defined(BM68) && !defined(XT8_V2) && !defined(RTAXE95Q) && !defined(ET8PRO) && !defined(ET8_V2) && !defined(ET12) && !defined(XT12) && !defined(TUFAX3000_V2) && !defined(RTAXE7800) && !defined(GT10) && !defined(GTBE98) && !defined(GTBE98_PRO) && !defined(GTBE96)
#if defined(RTAX86U)
	if(strcmp(get_productid(), "RT-AX86S"))
#endif
	...
	system("tmctl setqcfg --devtype 0 --if eth1 --qid 7 --priority 0 --weight 1 --schedmode 2 --shapingrate 2450000");
	system("tmctl setqcfg --devtype 0 --if eth1 --qid 6 --priority 0 --weight 1 --schedmode 2 --shapingrate 2450000");
	system("tmctl setqcfg --devtype 0 --if eth1 --qid 5 --priority 0 --weight 1 --schedmode 2 --shapingrate 2450000");
	system("tmctl setqcfg --devtype 0 --if eth1 --qid 4 --priority 0 --weight 1 --schedmode 2 --shapingrate 2450000");
...
{
#if defined(RTAX55) || defined(RTAX1800) || defined(RTAX58U_V2) || defined(RTAX3000N) || defined(BR63) || defined(GTBE98) || defined(GTBE98_PRO) || defined(GTBE96) //handle dualwan on rtkswitch
#ifdef RTCONFIG_DUALWAN
	int unit = 0;
	char wan_if[10];
	if (is_router_mode()) {
	...
	for (idx = 0; idx < unit_total ; idx++) {
		...
		switch(model) {
			...
			case MODEL_RTAX88U_PRO:
					 snprintf(macaddr_str, sizeof(macaddr_str), "%d:macaddr", unit + 1);
				break;
#if defined(GTAXE16000) || defined(GTAX11000_PRO) || defined(GT10) || defined(RTAX9000) || defined(GTBE98) || defined(RTBE96U) || defined(GTBE98_PRO) || defined(GTBE96)
			case MODEL_GTAX11000_PRO:
			case MODEL_GTAXE16000:
			case MODEL_GTBE98:
			case MODEL_GTBE98_PRO:
...
void load_wl()
{
	...
	char dhd_iface_name_str[60] = "iface_name=wl nvram_ifid_override=1";
#else
...
#if defined(RTAX92U) || defined(RTCONFIG_HND_ROUTER_AX_675X) || defined(RTCONFIG_HND_ROUTER_AX_6756) || (defined(RTCONFIG_HND_ROUTER_BE_4916) && !defined(BCM6813)) || defined(RTCONFIG_HND_ROUTER_AX_6710) && !defined(BCM4912)
...
#if defined(RTAX95Q) || defined(XT8PRO) || defined(BT12) || defined(BQ16) || defined(BM68) || defined(XT8_V2) || defined(RTAXE95Q) || defined(ET8PRO) || defined(ET8_V2) || defined(BCM6750) || defined(BCM63178)
...
#if defined(GTAXE16000) || defined(GTBE98) || defined(GTBE98_PRO) || defined(GT10) || defined(RTAX9000)
...
/* Spefici net devices order for BT12 */
		...
		if (nvram_match("switch_stb_x", "1") && nvram_match("switch_wantag", "none")) {
			...
			if (nvram_match("switch_wantag", "m1_fiber")
				...
				else if (model == MODEL_RTAX95Q || model == MODEL_XT8PRO || model == MODEL_BT12 || model == MODEL_BQ16 || model == MODEL_BM68 || model == MODEL_XT8_V2 || model == MODEL_RTAXE95Q || model == MODEL_ET8PRO || model == MODEL_ET8_V2 || model == MODEL_GT10) {
					sprintf(ethPort2, "eth3");
					sprintf(vlanDev2, "eth3.v0");
				}
#if defined(RTAX82_XD6) || defined(XD6_V2)
			...
			else if (model == MODEL_RTAX95Q || model == MODEL_XT8PRO || model == MODEL_BT12 || model == MODEL_BQ16 || model == MODEL_BM68 || model == MODEL_XT8_V2 || model == MODEL_RTAXE95Q || model == MODEL_ET8PRO || model == MODEL_ET8_V2 || model == MODEL_GTAX6000 || model == MODEL_GTAX11000_PRO || model == MODEL_GTAXE16000 || model == MODEL_RTAX86U_PRO || model == MODEL_RTAX88U_PRO || model == MODEL_RTBE96U) {
			...
			if (nvram_match("switch_wantag", "singtel_mio")) {
				...
				else if (model == MODEL_RTAX95Q || model == MODEL_XT8PRO || model == MODEL_BT12 || model == MODEL_BQ16 || model == MODEL_BM68 || model == MODEL_XT8_V2 || model == MODEL_RTAXE95Q || model == MODEL_ET8PRO || model == MODEL_ET8_V2 || model == MODEL_GTAX6000 || model == MODEL_GTAX11000_PRO || model == MODEL_GTAXE16000 || model == MODEL_RTAX86U_PRO || model == MODEL_GT10 || model == MODEL_RTAX88U_PRO || model == MODEL_RTBE96U) {
				/* exclude ET12/XT12 due to GPY211 LAN port can't be iptv/voip port */
					sprintf(ethPort3, "eth2");
					sprintf(vlanDev3, "eth2.v0");
					sprintf(ethPort4, "eth3");
	...
	case MODEL_GTBE96:
		...
		if (nvram_match("switch_stb_x", "1") && nvram_match("switch_wantag", "none")) {
			...
			/* use vconfig only for STB compatability */
				...
				eval("brctl", "delif", "br0", "eth1");
#if defined(GTBE98) || defined(GTBE98_PRO) || defined(GTBE96)
				__setup_vlan(iptv_vid, 0, 0x00100010); // LAN4 tag
				__setup_vlan(0, 0, 0x00E000E0); //no-tag fwd mask except LAN4
#elif defined(RTAX55) || defined(RTAX58U_V2) || defined(RTAX3000N) || defined(BR63) && !defined(NEW_SWITCH_ORDER)
